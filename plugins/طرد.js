let handler = async (m, { conn, participants, usedPrefix, command }) => {
  let developerNumber = '201036547166@s.whatsapp.net'; // استبدل بالرقم الخاص بالمطور بصيغة JID
  ...
  m.reply(
    `*❍━━━══━━❪⛩️❫━━══━━━❍*\n*｢⚡️｣⇇تـم ركلك بـي نـجـاح*\n*｢⚡️｣⇇بـي امـر مـن↜┊@${m.sender.split('@')[0]}┊*\n*❍━━━══━━❪⛩️❫━━══━━━❍*`
  );
};

handler.help = ['kick @user'];
handler.tags = ['group'];
handler.command = ['kick', 'ركل'];
handler.admin = true;
handler.group = true;
