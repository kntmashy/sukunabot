...
*❍━━━══━━❪⛩️❫━━══━━━❍*`.trim();
    conn.tekateki[id] = [
        ...
        json, poin,
        setTimeout(async () => {
            if (conn.tekateki[id]) await conn.reply(m.chat, `*⊏─๋︩︪─๋︩︪─๋︩︪─๋︩︪─═͜⊐❪⛩️❫⊏═─๋︩︪─๋︩︪─๋︩︪─๋︩︪─๋︩︪─⊐*\n*⛩️⇇انتهى الوقت💔*\n*｢⛩️｣⇇الايجابه↜❪${json.response}❫*\n*⊏─๋︩︪─๋︩︪─๋︩︪─๋︩︪─═͜⊐❪⛩️❫⊏═─๋︩︪─๋︩︪─๋︩︪─๋︩︪─๋︩︪─⊐*`, conn.tekateki[id][0]);
